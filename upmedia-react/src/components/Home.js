      ...
      <div>
        <div>
          ...
          <ul>
            ...
            <li>
              CreateDashboard component shows how to display the dashboard editor to create a new dashboard from scratch
              and how to return a custom list of data sources for the user to select from.
            </li>
